...
class PlayerVideoService {
  ...
  Future<String?> authorizedStreamUrl(PlayerVideoDto video) async {
  ...
  Future<List<PlayerVideoDto>> getVideos(
    String clubId,
    String teamId,
    String playerUserId,
  ) async {
    ...
    return (json as List)
        .map(
          (e) => PlayerVideoDto.fromJson(Map<String, dynamic>.from(e as Map)),
        )
        .toList();
  }
  ...
  Future<void> deleteVideo(
    ...
    await _api.delete(
      '/clubs/$clubId/teams/$teamId/players/$playerUserId/videos/$videoId',
    );
  }
}
