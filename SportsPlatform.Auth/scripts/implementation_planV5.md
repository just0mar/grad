...
|---|---|---|---|
| **OD-1** | Should managers see ALL pending approval requests, or only those from users who selected their team? | Show all (Manager picks team during approval) | Phase 0B (pending-approvals endpoint only; does not block the membership/invitation redesign) |
...
| Coaching Plans | R | R (own teams) | W (own plans) | W (own plans) | -- | R (team-visible) | R (player-assigned only) |
...
| RLS session | JWT claims via middleware | [RlsMiddleware](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/SportsPlatform.Auth.Api/Middleware/RlsMiddleware.cs#11-15) sets `app.user_id`, `app.user_roles` |
...
| **Grace period**: | After privilege revocation, the user's **existing access token may remain valid for up to 5 minutes** until it expires naturally. JWTs are stateless and cannot be force-invalidated. This is an accepted trade-off for simplicity. |
...
**Code changes**:
- [SportsPlatform.Auth.Core/Entities/Team.cs](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/SportsPlatform.Auth.Core/Entities/Team.cs) -- remove `ManagerUserId`, add `ICollection<TeamManager>`
- `SportsPlatform.Auth.Core/Entities/TeamManager.cs` [NEW] -- junction entity
- [SportsPlatform.Auth.Infrastructure/Services/TeamService.cs](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/SportsPlatform.Auth.Infrastructure/Services/TeamService.cs) -- 6 locations using `ManagerUserId`
- [SportsPlatform.Auth.Infrastructure/Services/ApprovalService.cs](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/SportsPlatform.Auth.Infrastructure/Services/ApprovalService.cs) -- ownership check at line 94
- [SportsPlatform.Auth.Core/DTOs/Response/TeamDto.cs](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/SportsPlatform.Auth.Core/DTOs/Response/TeamDto.cs) -- replace single manager with list
- [scripts/rls_policies.sql](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/scripts/rls_policies.sql) -- rebuild all team policies
...
- Fix [RlsMiddleware](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/SportsPlatform.Auth.Api/Middleware/RlsMiddleware.cs#11-15) to pipe-delimited format
...
**Unique**: [(event_id, instance_date, player_id)](file:///C:/Users/Mega%20Store/.gemini/antigravity/scratch/SportsPlatform.Auth/SportsPlatform.Auth.Core/Entities/User.cs#3-21)
